                    ...
                    <div className="transfer-card__wrapper">
                        ...
                        <div className="transfer-card__content-grid">
                            ...
                            <div className="transfer__content">
                                ...
                                <div className="aside__container">
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer__destination"/>
                                        <label className="radio__label">Account
                                        </label>
                                    </div>
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer__destination"/>
                                        <label className="radio__label">Facebook
                                        </label>
                                    </div>
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer__destination"/>
                                        <label className="radio__label">Phone
                                        </label>
                                    </div>
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer__destination"/>
                                        <label className="radio__label"> Email
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="transfer__content">
                                ...
                                <div className="aside__container">
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer"/>
                                        <label className="radio__label"><b>Normaly</b><br/>
                                            About 7 days
                                        </label>
                                    </div>
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer"/>
                                        <label className="radio__label"><b>Express Eliksir</b><br/>
                                            15 min
                                        </label>
                                    </div>
                                    <div className="transfer__content">
                                        <input type="radio" className="recipent__input input--radio" name="transfer"/>
                                        <label className="radio__label"><b>Sorbnet</b>
                                            <br/>2 hours
                                        </label>
                                    </div>
                                </div>
